...
<div class="product-tab z-index-20 sm-margin-top-193px xs-margin-top-30px">
                <div class="container">
                    <div class="biolife-title-box">
                        <span class="subtitle">Senin için...</span>
                        <h3 class="main-title">En iyi Ürünler</h3>
                    </div>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol"></span><?php echo $eight_pdt_ctg_five['pdt_price']?> TL</span></ins>
